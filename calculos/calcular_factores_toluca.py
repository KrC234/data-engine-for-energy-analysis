...
#
# parents[2] apunta a la raíz del repositorio.
...
def cargar_datos():
    ...
    Por esa razón se omiten las primeras seis filas y se
...
def calcular_factor_socioeconomico(toluca):
    ...
    if not no_convertidos.empty:
        print(
            ...
            f"{len(no_convertidos):,} registros sin grado válido."
        )
...
def mostrar_resultados(resultado):
    ...
    print("\nDistribución por grado de rezago:")
    print("-" * 65)
